...
with open("praca_mgr\programy2\stubborn_model\params.json") as f:
    parameters = load(f)
...
# sym = simulation(g,g, 0.1, omega, 0.5, mu, v_step, kappa, mode)
# sym.init_states(p0_inf, p0_op_minus, p0_op_plus)

# sym.stubborness_dist_graph()
# sys.exit()
...
#from simulation_mod import simulation
...
df.to_csv(save_path + 'output_mod.csv')