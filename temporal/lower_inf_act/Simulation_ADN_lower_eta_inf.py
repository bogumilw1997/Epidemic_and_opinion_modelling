...
class Simulation():
    ...
    def __init__(self, N, m, beta, omega, gamma, mu, phi, kappa, v_step, eta, epsilon, w, d):
        ...
        self.opinion_activity_rate = np.minimum(self.opinion_activity * self.eta, np.ones_like(self.opinion_activity))
    ...
    def init_states(self, p0_inf, p0_op_minus, p0_op_plus):
        ...
        self.epidemic_activity_rate = self.epidemic_activity * self.eta
        self.epidemic_activity_rate[self.epidemic_state == "I"] = self.epidemic_activity_rate[self.epidemic_state == "I"]/self.d
